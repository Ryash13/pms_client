...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section
        className={`min-h-[100vh] min-w-fit flex flex-col justify-center mx-auto text-center`}
      >
      ...
      <section
        id="features"
        className={`dark:bg-dark-bg bg-gray-300/40 py-20 px-5`}
      >
        <div className="container mx-auto">
          <h3 className="text-3xl font-bold mb-12 text-center dark:text-gray-200 text-black">
            Key Features
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="dark:bg-dark-bg bg-gray-400/40">
                <CardContent className="pt-6">
                  <feature.icon className="h-12 w-12 mb-4 dark:text-blue-300 text-blue-400" />
                  <h4 className="text-xl font-semibold mb-2 dark:text-white text-black/90">
                    {feature.title}
                  </h4>
                  <p className="dark:text-gray-300 text-black/80">
                    {feature.description}
                  </p>
                </CardContent>
              </Card>
      ...
      {/* Companies Carousel */}
      <section className={`${isDarkMode ? "bg-dark" : "bg-light"} py-20`}>
        <div className="container mx-auto">
      ...
      {/* CTA Section */}
      <section className="py-20 dark:bg-dark-bg bg-gray-300/40 text-center px-5">
        <div className="container mx-auto dark:text-gray-300 text-black">
